...
$$
\begin{array}{cl}
&\min_{\alpha}{L_{val}(w^{\*}(\alpha), \alpha)} \\\ &\text{ s. t. } w^{\*}(\alpha)=\operatorname{argmin}_{w} L_{train}
\end{array}
$$

$$
\begin{array}{cl}
&\min_{\alpha}{L_{val}(w^{\*}(\alpha), \alpha)} \\\ &\text{ s. t. } w^{\*}(\alpha)=\operatorname{argmin}_{w} L_{train}(w, \alpha)
\end{array}
$$
