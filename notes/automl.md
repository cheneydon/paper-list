...
$$
\begin{array}{cl}
&\min_{\alpha}{L_{val}(w^{\*}(\alpha), \alpha)} \\\ &\text{ s. t. } w^{\*}(\alpha)={argmin}_w L_{train}(w, \alpha)
\end{array}
$$

$$
\begin{array}{cl}
&\min_{\alpha}{L_{val}(w^{\*}(\alpha), \alpha)} \\\ &\text{ s. t. } w^{\*}(\alpha)=\text{argmin}_w L_{train}(w, \alpha)
\end{array}
$$
